...
| <a name="input_integration_type"></a> [integration_type](#input\_integration\_type) | which service will send the data to the s3-sns, possible options are [`cloudtrail-sns`] | `string` | `s3-sns` | no |
