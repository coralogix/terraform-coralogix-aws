...
| <a name="input_CustomDomain"></a> [custom_domain](#input\_Custom_domain) | Custom Domain for coralogix | `string` | n/a | no |
...
| <a name="input_LayerARN"></a> [layer_arn](#input\_Layer_arn_) | Coralogix SSM Layer ARN (if SsmEnabled set to false, can leave as empty). | `string` | n/a | no |
