resource "aws_s3_bucket_notification" "lambda_notification" {
  for_each   = !local.is_traces && local.s3_bucket_names != toset([]) && local.sns_enable != true && var.sqs_name == null && var.telemetry_mode != "metrics" && var.s3_notification != false ? data.aws_s3_bucket.this : {}
