...
| <a name="create_execution_role"></a> [create_execution_role](#input\_create_execution_role) | Set to `false` when providing your own role via `execution_role_arn` or `execution_role_name`. | `bool` | `true` | no |
