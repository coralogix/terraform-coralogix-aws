...
|------|-------------|------|---------|:--------:|
| <a name="input_coralogix_region"></a> [coralogix\_region](#input\_coralogix\_region) | The Coralogix location region, possible options are [`Europe`, `Europe2`, `India`, `Singapore`, `US`, `Custom`] | `string` | `Europe` | no | ##### check the custom here
| <a name="input_custom_url"></a> [custom_url](#input\_custom_url) | Custom url for coralogix | `string` | n/a | no |
